...
/**
 * Paramater source used with inserts to the party_audit table.
 */
public class PartyAuditSqlParameterSource extends AuditSqlParameterSource {

    public PartyAuditSqlParameterSource(Party party) {
        super();
