...
@Service("supplierCertificationMutator")
@Transactional
public class SupplierCertificationMutator extends CertificationMutator {
	...
	protected final Certification doCreate(Certification certification) {
		return certificationWriteDao.insertSupplierCertification(certification);
	}
