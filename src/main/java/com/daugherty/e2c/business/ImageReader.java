...
public class ImageReader {
    ...
    public BufferedImage readImage(InputStream inputStream, String imageEncoding) throws IOException,
            ImageReadException {
        colorType = COLOR_TYPE_RGB;
        hasAdobeMarker = false;

        if ("gif".equalsIgnoreCase(imageEncoding) || "png".equalsIgnoreCase(imageEncoding)) {
    ...
    public static BufferedImage convertCmykToRgb(Raster cmykRaster, ICC_Profile cmykProfile) throws IOException {
        if (cmykProfile == null)
            cmykProfile = ICC_Profile.getInstance(ImageReader.class
                    .getResourceAsStream("/image/ISOcoated_v2_300_eci.icc"));
