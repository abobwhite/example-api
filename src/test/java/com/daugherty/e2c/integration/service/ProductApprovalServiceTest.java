...
public class ProductApprovalServiceTest {
    ...
    public void submitForApproval() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/productApprovals/23/submitted").principal(authentication))
    ...
    public void deferApproval() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/productApprovals/24/deferred").principal(authentication))
                .andDo(MockMvcResultHandlers.print()).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void disapprove() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/productApprovals/24/disapproved").principal(authentication))
                .andDo(MockMvcResultHandlers.print()).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void requestTranslation() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/productApprovals/24/translations").principal(authentication))
                .andDo(MockMvcResultHandlers.print()).andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    public void approve() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/productApprovals/24/approved").principal(authentication))
                .andDo(MockMvcResultHandlers.print()).andExpect(MockMvcResultMatchers.status().isOk());
    }
