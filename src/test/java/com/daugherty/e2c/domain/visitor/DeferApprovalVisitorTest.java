...
public class DeferApprovalVisitorTest {

    private static final int CURRENT_VERSION = 5;

    private final DeferApprovalVisitor visitor = new DeferApprovalVisitor();
    ...
    public void getNewVersionForUnprofiledStatusThrowsException() {
        ...
        expectedException.expectMessage("Cannot defer approval of something that is " + ApprovalStatus.UNPROFILED);
    ...
    public void getNewVersionForDraftStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Cannot defer approval of something that is " + ApprovalStatus.DRAFT);
    ...
    public void getNewVersionForWaitingForInformationStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Cannot defer approval of something that is "
    ...
    public void getNewVersionForApprovedStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Cannot defer approval of something that is " + ApprovalStatus.APPROVED);
    ...
    public void getNewVersionForDisapprovedStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Cannot defer approval of something that is " + ApprovalStatus.DISAPPROVED);
    ...
    @Test
    public void getNewApprovalStatusForPendingApprovalStatusReturnsWaitingForInformationStatus() {
        assertThat(visitor.getNewApprovalStatus(ApprovalStatus.PENDING_APPROVAL),
                is(ApprovalStatus.WAITING_FOR_INFORMATION));
    }
