...
public class DisapproveVisitorTest {

    private static final int CURRENT_VERSION = 5;

    private final DisapproveVisitor visitor = new DisapproveVisitor();
    ...
    public void getNewVersionForUnprofiledStatusThrowsException() {
        ...
        expectedException.expectMessage("Cannot disapprove something that is " + ApprovalStatus.UNPROFILED);
    ...
    public void getNewVersionForDraftStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Cannot disapprove something that is " + ApprovalStatus.DRAFT);
    ...
    public void getNewVersionForWaitingForInformationStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException
                .expectMessage("Cannot disapprove something that is " + ApprovalStatus.WAITING_FOR_INFORMATION);
    ...
    public void getNewVersionForPendingTranslationStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Cannot disapprove something that is " + ApprovalStatus.PENDING_TRANSLATION);
    ...
    public void getNewVersionForApprovedStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Cannot disapprove something that is " + ApprovalStatus.APPROVED);
    ...
    public void getNewVersionForDisapprovedStatusThrowsException() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Cannot disapprove something that is " + ApprovalStatus.DISAPPROVED);
    ...
    @Test
    public void getNewApprovalStatusForPendingApprovalStatusReturnsDisapprovedStatus() {
        assertThat(visitor.getNewApprovalStatus(ApprovalStatus.PENDING_APPROVAL), is(ApprovalStatus.DISAPPROVED));
    }
