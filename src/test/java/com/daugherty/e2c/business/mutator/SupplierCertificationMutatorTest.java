...
public class SupplierCertificationMutatorTest {
	...
	@InjectMocks
	public CertificationMutator supplierCertificationMutator = new SupplierCertificationMutator();
	
	@Test
	public void verifyThatDeleteThrowsUnsupportedOperationException(){
		expectedException.expect(UnsupportedOperationException.class);
		CertificationMutator certificationMutator = new SupplierCertificationMutator();
	...
	public void verifyThatUpdateThrowsUnsupportedOperationException(){		
		...
		supplierCertificationMutator.update(testCertification);		
	}
	...
	public void verifyThatCreateHitsDao(){
		...
		when(certificationWriteDao.insertSupplierCertification(certification)).thenReturn(certification);
		Certification createdCertification = supplierCertificationMutator.create(certification);
