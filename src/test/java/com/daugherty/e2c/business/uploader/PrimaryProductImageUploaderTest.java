...
public class PrimaryProductImageUploaderTest {
    ...
    @InjectMocks
    private final PrimaryProductImageUploader productImageUploader = new PrimaryProductImageUploader();
    ...
    public void uploadDocumentReturnsURLAndMarksAsPrimary() throws IOException {
        ...
        assertTrue(productImage.isPrimary());
    ...
    @Test
    public void uploadDocumentReturnsValidationErrorWhenExceedsMaxImages() throws IOException {
