...
public class SupplierLogoUploaderTest {
    @Mock
    ...
    @InjectMocks
    private final SupplierLogoUploader supplierLogoUploader = new SupplierLogoUploader();

    @Test
    public void uploadDocumentReturnsURL() throws IOException {
        Long id = 1L;
        String documentKey = DocumentType.SUPPLIER_LOGO.getType() + id;
        ...
        String uploadedDocumentKey = supplierLogoUploader.uploadDocument(id, contentType, inputStream);
